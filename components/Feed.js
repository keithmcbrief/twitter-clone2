...
function Feed() {
  ...
  return (
    <div
     ...
     sm:ml-[73px] xl:ml-[400px] xl:max-w-[600px]"
    >
      <div
        className="text-[#d9d9d9] flex items-center sm:justify-between
        py-3 px-3 sticky top-0 z-50 bg-black border-gray-700"
      >
        <h2 className="text-lg sm:text-xl font-bold">Home</h2>
        <div
          className="hoverAnimation scrollbar-hide w-9 h-9 flex items-center 
